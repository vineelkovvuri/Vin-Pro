...
3) apply function Fk to the permutated o/p using the key k2
4) apply switch function to o/p of Fk (which just exchanges the right and left 4 bits)
5) apply function Fk to the switched o/p using the key k1
6) apply inverse permutation 

input: 
======
(give the input as it is with spaces )

Enter an 8 bit plain text : 0 1 1 1 0 1 0 1
Enter an 10 bit key : 1 0 1 0 0 0 0 0 1 0

ouput:
======
Generated Key k1 : 10100100
Generated Key k2 : 01000011
Initial Permutation : 11101100
Resul1 after applying Function Fk : 11101100
Switch Function of Resul1 : 11001110
Resul2 after applying Function Fk : 01111110
