...
int main()
{
	...
	f = *(int*)&t;   //copies the content of the address of t as it is; where as f = (int)t will convert t to float and spoil the underlying floating point bit representation.
