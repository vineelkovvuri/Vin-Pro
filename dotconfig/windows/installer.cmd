...
winget install -h --id "Trimble.SketchUp.Pro.2022"                 --accept-source-agreements   --accept-package-agreements
winget install -h --id "XK72.Charles"                              --accept-source-agreements   --accept-package-agreements
winget install -h --id "namazso.OpenHashTab"                       --accept-source-agreements   --accept-package-agreements
